...
const newUsuario = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const usuarioCorreo = yield usuario_1.Usuario.findOne({ where: { EMAIL_USUARIO: email } });
    const usuarioRut = yield usuario_1.Usuario.findOne({ where: { RUT_USUARIO: rut_usuario } });
    const institucion = yield institucion_1.Institucion.findOne({ where: { ID_INSTITUCION: 1 } });
    const rol = yield rol_1.Rol.findOne({ where: { ID_ROL: 1 } });
    if (usuarioCorreo) {
...
const loginUser = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const usuario = yield usuario_1.Usuario.findOne({ where: { EMAIL_USUARIO: email } });
    if (!usuario) {
